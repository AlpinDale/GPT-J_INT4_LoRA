...
def parse_commandline():
    ...
    parser_config.add_argument("--gptj_q4_config_dir", default="./gptj-6b-4bit/", required=False,
        help="Path to the config.json, tokenizer_config.json, etc. Default: %(default)s"
    )
    parser_config.add_argument("--gptj_q4_model", default="./gptj-6b-4bit.pt", required=False,
...
def get_config() -> Finetune4bConfig:
    ...
    return Finetune4bConfig(
        ...
        gptj_q4_config_dir=args["gptj-6b_q4_config_dir"],
        gptj_q4_model=args["gptj-6b_q4_model"],
