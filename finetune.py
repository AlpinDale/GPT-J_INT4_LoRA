"""
    GPT-J 4bit trainer with support of Stanford Alpaca-like JSON datasets (short for SAD)
...
import torch
import transformers
from autograd_4bit import load_gptj_model_4bit_low_ram
...
# Load Basic Model
model, tokenizer = load_gptj_model_4bit_low_ram(ft_config.gptj_q4_config_dir,
                                                  ft_config.gptj_q4_model,
